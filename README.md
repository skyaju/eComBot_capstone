# eComBot (Day 06 — Multi-Agent Architecture)

eComBot is a Google ADK-powered e-commerce support assistant that now runs as a **production-style multi-agent system** backed by OpenRouter model routing, session memory, RAG knowledge retrieval, and structured observability tracing.
